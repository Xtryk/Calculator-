...
public class Calculator implements ActionListener{
    ...
    //variables that are included into math operations
    double num1=0;
    double num2=0;
    double result=0;
    char operator;
    ...
    Calculator() {
        ...
        //adding special buttons into array
        functionButtons[0] = addButton;
        functionButtons[1] = subButton;
        functionButtons[2] = muButton;
        ...
        //adding all previously specified components into frame and setting it visible
        frame.add(panel);
        frame.add(negButton);
    ...
    //Overriding action methods which shall be conducted by buttons in the calculator
    @Override
